        ...
        <div className="max-w-5xl mx-auto px-5 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <button onClick={handleSignOut} className="text-[#A7A5A6] hover:text-red-400 text-xs px-3 py-1.5 rounded-lg border border-[#222] hover:border-red-400/40 transition-colors">
                Sign Out
              </button>
              {/* Backup / Restore */}
