...
export const JOB_ASSEMBLIES = {
  ...
  service: [
    ...
    { id: 'service_mast_conduit', name: 'Service Mast Conduit (per 10ft)', material: 28, laborHrs: 0.75, unit: '10ft', isConduit: true, notes: 'Rigid or IMC conduit for overhead service mast' },
    { id: 'weatherhead', name: 'Weatherhead (service entrance cap)', material: 45, laborHrs: 1.0, unit: 'each', notes: 'Overhead service — connects to utility drop' },
    { id: 'service_conduit_ug', name: 'Underground Service Conduit (per 10ft)', material: 22, laborHrs: 0.75, unit: '10ft', isConduit: true, notes: 'PVC Sch 40 underground from meter to panel' },
    { id: 'service_conduit_exposed', name: 'Service Conduit Exposed/Surface (per 10ft)', material: 24, laborHrs: 0.65, unit: '10ft', isConduit: true, notes: 'Rigid or EMT — exterior wall surface mount' },
